...
const ollAlgorithms = [
    ...
    { id: 49, setup: "F' R U2 R' U2 R' F2 R F'", algorithm: "F R' F2 R U2 R U2 R' F" },
    { id: 50, setup: "F L' U2 L U2 L F2 L' F", algorithm: "F' L F2 L' U2 L' U2 L F'" },
    ...
    { id: 53, setup: "Same as Algo", algorithm: "r' U' (R U' R') U (R U' R') U2 r (or) U r' U2 (R U R') U' (R U R') U r" },
    { id: 54, setup: "Same as Algo", algorithm: "l U (L' U L) U' (L' U L) U2 l' (or) U' l U2 (L' U' L) U (L' U' L) U' l'" },
